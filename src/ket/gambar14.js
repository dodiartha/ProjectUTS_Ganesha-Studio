          ...
          <ScrollView style={styles.scrollView}>
              <View style={styles.box3}>
                <TouchableOpacity style={styles.iconContainer2}>
                  <Text style={{ fontSize: 26, color: 'white'}}> MINIATUR</Text>
                 ...
                 <Text style={{ fontSize: 12, color: 'white'}}> 1 Lokasi ( Autdoor ) </Text>
                   <Text style={{ fontSize: 12, color: 'white'}}> 1X Rias + Costum Moderen</Text>
                 ...
                 <Text style={{ fontSize: 12, color: 'white'}}> 2 Kamera Standar & 1 Kamera Infra Red </Text>
                   <Text style={{ fontSize: 12, color: 'white'}}> 2X Rias + Costum Moderen ( bebas pilihan )</Text>
                 <Text style={{ fontSize: 12, color: 'white'}}>  2 Lokasi Pemotretan </Text>
                 ...
                 <Text style={{ fontSize: 12, color: 'white'}}>  3-4 Buah pilihan Costum Moderen Bebas </Text>
                 <Text style={{ fontSize: 12, color: 'white'}}>  3-4 Lokasi Pemotretan </Text>
                 <Text style={{ fontSize: 12, color: 'white'}}> 2 Foto 20R + 2 Frame Ukir </Text>
                  <Text style={{ fontSize: 12, color: 'white'}}> 60 Foto Edit dalam 1 Album Ganesha Studio </Text>
                 <Text style={{ fontSize: 12, color: 'white'}}>  1 DVD file Foto Edit & Original </Text>
                   <Text style={{ fontSize: 12, color: 'white'}}> Sudah termasuk Transportasi </Text>
