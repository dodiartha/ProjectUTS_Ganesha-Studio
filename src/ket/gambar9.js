          ...
          <ScrollView style={styles.scrollView}>
              <View style={styles.box3}>
                <TouchableOpacity style={styles.iconContainer2}>
                  <Text style={{ fontSize: 26, color: 'white'}}> ADAT JAWA </Text>
                 ...
                 <Text style={{ fontSize: 12, color: 'white'}}> 1 Lokasi ( Autdoor ) </Text>
                   <Text style={{ fontSize: 12, color: 'white'}}> 1X Rias + Costum Jawa </Text>
                 ...
                 <Text style={{ fontSize: 12, color: 'white'}}> 2 Kamera Standar & 1 Kamera Infra Red </Text>
                   <Text style={{ fontSize: 8, color: 'white'}}> 2X Rias + Costum Jawa Modifikasi ( bebas pilihan ) + Costum Jawa </Text>
