          ...
          <ScrollView style={styles.scrollView}>
              <View style={styles.box3}>
                <TouchableOpacity style={styles.iconContainer2}>
                  <Text style={{ fontSize: 26, color: 'white'}}> ADAT BALI KLASIK </Text>
                 ...
                 <Text style={{ fontSize: 12, color: 'white'}}> 1 Lokasi ( Outdoor ) </Text>
                   <Text style={{ fontSize: 12, color: 'white'}}> 1X Rias + Costum Bali Klasik </Text>
                 ...
                 <Text style={{ fontSize: 12, color: 'white'}}> 2 Kamera Standar & 1 Kamera Infra Red </Text>
                   <Text style={{ fontSize: 9, color: 'white'}}> 2X Rias + Costum Bali Modifikasi ( bebas pilihan ) + Costum Bali Klasik </Text>
                 ...
                 <Text style={{ fontSize: 8, color: 'white'}}>  3-4 Buah pilihan Costum ( Bali Modifikasi, Bali Payas Agung, Bali Klasik ) </Text>
